...
/home/warsier/Documents/PIMProf_solver/build/PIMProfSolver/Solver.exe mpki -c inj_cpu/pimprofstats.out -p inj_pim/pimprofstats.out -r inj_cpu/pimprofreusesegments.out -o mpkidecision.out
