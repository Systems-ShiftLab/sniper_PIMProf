...
UInt64 MagicServer::Magic_unlocked(thread_id_t thread_id, core_id_t core_id, UInt64 cmd, UInt64 arg0, UInt64 arg1)
{
   switch(cmd)
   {
      ...
      case SIM_PIMPROF_BBL_START: // [Yizhou]
         Sim()->PIMProfBBLStart(Sim()->getThreadManager()->getCurrentThread()->getId(), arg0, arg1);
         return 0;
      case SIM_PIMPROF_BBL_END: // [Yizhou]
         Sim()->PIMProfBBLEnd(Sim()->getThreadManager()->getCurrentThread()->getId(), arg0, arg1);
         return 0;
      case SIM_PIMPROF_OFFLOAD_START: // [Yizhou]
         Sim()->PIMProfOffloadStart(Sim()->getThreadManager()->getCurrentThread()->getId(), arg0, arg1);
         return 0;
      case SIM_PIMPROF_OFFLOAD_END: // [Yizhou]
         Sim()->PIMProfOffloadEnd(Sim()->getThreadManager()->getCurrentThread()->getId(), arg0, arg1);
         return 0;
      default:
